...
public final class UtilsString {
     ...
     */
    public static String padRight(String text, int numeberOfCharactersPad) {
     ...
     */
    public static String padLeft(String text, int numeberOfCharactersPad) {
        return String.format("%" + numeberOfCharactersPad + "s", text);
    }
     ...
     * @return true if null or empty false if not
     */
    public static boolean isEmpty(String value, boolean checkNull) {
     ...
     * @return true if value is not null and not empty, false if not
     */
    public static boolean isNotEmpty(String value, boolean checkNull) {
     ...
     */
    public static String ramdomString(int targetStringLength) {
     ...
     */
    public static String replaceAllChars(String text, char charReplace, char newChar) {
     ...
     */
    public static String replaceAllString(String text, String replace, String newString) {
     ...
     */
    public static boolean contaisChar(String text, char charToCheck) {
